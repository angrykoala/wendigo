...
module.exports = {
    ...
    _equalAssertion(countData, elementsFound, msg, selector) {
        ...
        if(elementsFound !== expected) {
            ...
            return assertUtils.rejectAssertion(msg, expected, elementsFound);
        }
    },
    ...
    _bothAssertion(countData, elementsFound, msg, selector) {
        ...
        if(elementsFound < least || elementsFound > most) {
            if(!msg) msg = `Expected selector "${selector}" to find between ${countData.atLeast} and ${countData.atMost} elements, ${elementsFound} found`;
            return assertUtils.rejectAssertion(msg);
        }
    },
