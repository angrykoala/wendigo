...
const BrowserRequestsInterceptor = require('./requests/interceptor');
...
module.exports = class Browser extends BrowserBase {
    ...
    constructor(page, settings) {
        ...
        this.requests = new BrowserRequestsInterceptor(this.page);
        this.assert.request = new RequestAssertions(this);
    }
    ...
    open(url) {
        ...
        return this.page.goto(url).then(() => {
            return this.page.content().then((content) => {
                ...
                this.assert.request._requestSet = this.requests.filter;
