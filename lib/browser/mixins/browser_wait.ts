...
import { WaitForCallbackFunction, PuppeteerErrors, SerializableOrJSHandle } from '../../puppeteer_wrapper/puppeteer_types';
...
export default abstract class BrowserWait extends BrowserNavigation {
    ...
    public async waitFor(selector: WaitForCallbackFunction, timeout?: number, ...args: Array<SerializableOrJSHandle | DomElement>): Promise<void>;
    @FailIfNotLoaded
    @OverrideError()
    public async waitFor(selector: WaitForCallbackFunction | string, timeout?: number, ...args: Array<SerializableOrJSHandle | DomElement>): Promise<void> {
