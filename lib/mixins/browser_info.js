    ...
    return class BrowserInfo extends s {
        ...
        options(selector) {
            ...
            return this.evaluate((q) => {
                ...
                const error = new QueryError(`Element "${selector}" not found when trying to get options.`);
        ...
        selectedOptions(selector) {
            ...
            return this.evaluate((q) => {
                ...
                const error = new QueryError(`Element "${selector}" not found when trying to get selected options.`);
                return Promise.reject(error);
            });
        }
        ...
        class(selector) {
            ...
            return this.evaluate((q) => {
                ...
                const error = new QueryError(`Selector "${selector}" doesn't match any elements when trying to get classes.`);
                return Promise.reject(error);
            });
        }
        ...
        attribute(selector, attributeName) {
            ...
            return this.evaluate((q, attr) => {
                ...
                const error = new QueryError(`Element "${selector}" not found when trying to get attribute "${attributeName}".`);
                return Promise.reject(error);
            });
        }
        ...
        styles(selector) {
            ...
            return this.evaluate((q) => {
                ...
                const error = new QueryError(`Element "${selector}" not found when trying to get styles.`);
                return Promise.reject(error);
            });
        }
        ...
        style(selector, styleName) {
            ...
            return this.styles(selector).then((styles) => {
                ...
                const error = new QueryError(`Element "${selector}" not found when trying to get style "${styleName}".`);
                return Promise.reject(error);
            });
        }
        ...
        checked(selector) {
            ...
            return this.evaluate((q) => {
                ...
                const error = new QueryError(`Element "${selector}" not found when trying to get if checked.`);
                return Promise.reject(error);
            });
        }
    };
