...
const BrowserAssertions = require('./modules/assertions/browser_assertions');
const LocalStorageAssertions = require('./modules/assertions/local_storage_assertions');
const BrowserLocalStorage = require('./modules/browser_local_storage');
const BrowserCookies = require('./modules/browser_cookies');
