...
module.exports = class BrowserAssertions {
    ...
    cookie(...params) {
        // Deprecated
        console.warn("Warning: Browser.assert.cookie is deprecated, use browser.asssert.cookies instead."); //eslint-disable-line
        return this.cookies(...params);
    }

    webworker(...params) {
        // Deprecated
        console.warn("Warning: Browser.assert.webworker is deprecated, use browser.asssert.webworkers instead."); //eslint-disable-line
