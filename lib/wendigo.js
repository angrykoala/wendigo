...
const defaultPlugins = [{
    name: "cookies",
    plugin: require('./modules/browser_cookies')
}, {
    name: "localStorage",
    plugin: require('./modules/browser_local_storage'),
    assertions: require('./modules/assertions/local_storage_assertions')
}, {
    name: "requests",
    plugin: require('./modules/browser_requests')
}, {
    name: "console",
    plugin: require('./modules/browser_console')
}, {
    name: "webworkers",
    plugin: require('./modules/browser_webworkers')
}];
